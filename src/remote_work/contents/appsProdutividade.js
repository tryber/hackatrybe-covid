const content = `## Como Melhorar seu Foco e Produtividade

<h2 id="acordar-id"> Primeiro passo: acordar! </h2>
...
<h2 id="organizar-id" Segundo passo: *organização é fundamental*.</h2>
...
<h2 id="plus-id"> Além disso, ajuda: </h2>
...
<h2 id="outras-sugestoes-id"> Outras sugestões </h2>
...
const obj = {
  ...
  content,
  nav: [
    { link: 'Acordar!', href: 'acordar-id' }, // id para navegação
    { link: 'Organização é fundamental', href: 'organizar-id' }, // id para navegação
    { link: 'Finalmente', href: 'finalmente-id' }, // id para navegação
    { link: 'Tambem ajuda', href: 'plus-id' }, // id para navegação
    { link: 'Otras Sugestões', href: 'outras-sugestoes-id' }, // id para navegação
  ],
}
